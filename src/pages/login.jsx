...
function AuthModal({ open, onClose, signedIn, showSignIn, setShowSignIn, setSignedIn, setUserName, userName }) {
    if (!open) return null;
    return (
    ...
    return (
        <>
          ...
          Edit <code>src/App.jsx</code> and save to test HMR
            ...
            <button className="auth-modal-btn" onClick={() => setModalOpen(true)}>
                Open Auth Modal
            </button>
            <AuthModal
                open={modalOpen}
